    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title" class="page-title-parallax page-title-dark"
            ...
            <div class="container clearfix">
                <!-- <div class="float-left slider-caption "> -->
                    <h1 style="display: flex; justify-content: center; align-items: center; width: 100%;">Completed Events - University Of Nicosia, Cyprus</h1>
                <!-- </div> -->
            </div>
        </section>
        ...
        <section class="lpu-top-bottom-new">
            <div class="container clearfix grid-outer">
                <!-- Add your PDF here -->
                <embed src="EU-SPIRIT  Cyprus  Traninig   Project Meetings 22 -26 May 2023.pdf" type="application/pdf" width="100%" height="600px" />
