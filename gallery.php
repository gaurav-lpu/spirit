				...
				<div class="row">
					<div class="col-md-6 mt30">
						<div class="grid-outer">
							<a href="https://photos.app.goo.gl/BKgP4mridWTkeJtk8" target="_blank">Virtual Study Visit to European HEIs</a>
						</div>
					</div>
					<div class="col-md-6 mt30">
						<div class="grid-outer">
							<a href="https://photos.app.goo.gl/RmDrpP4LFAnavGbr8" target="_blank">MoU Ceremony</a>
						</div>
					</div> 
					<div class="col-md-6 mt30">
						<div class="grid-outer">
							<a href="https://photos.app.goo.gl/ScQFtDfgGQPaEjS18" target="_blank">Monthly Meeting</a>
						</div>
					</div>
				</div>
			</div>
