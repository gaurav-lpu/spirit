    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title" class="page-title-parallax page-title-dark"
            ...
            <div class="container clearfix">
                <!-- <div class="float-left slider-caption "> -->
                    <h1 style="display: flex; justify-content: center; align-items: center; width: 100%;">Completed Events - Universitas Syiah Kuala, Indonesia</h1>
                <!-- </div> -->
            </div>
        </section>
        ...
        <section class="lpu-top-bottom-new">
            <div class="container clearfix grid-outer">
                <!-- Add your PDF here -->
                <embed src="USK visit.pdf" type="application/pdf" width="100%" height="600px" />
