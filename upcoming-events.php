...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section style="margin-top:50px; margin-bottom:50px;">
			<div class="container clearfix grid-outer">
				<h3 style="text-align:center;">SPIRIT PROJECT MEETINGS</h3>
				<img src="lisbon1.jpg" alt="Lisbon Event">
				</div>
		</section>
		<h5>Sport and Physical Education as a Vehicle for Inclusion and Recognition In India, Indonesia and Sri Lanka / SPIRIT Erasmus+ Project Ref: 617779-EPP-1-2020-1-IN-EPPKA2-CBHE-JP</h5>
